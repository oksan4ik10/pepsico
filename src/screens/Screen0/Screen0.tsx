    ...
    return <div className={style.wrapper}>
        <main className={style.main}>
            ...
            <p className={style.main__text}>
                Собеседование — это всегда<br />волнительно. Но что, если у тебя<br />есть возможность заранее узнать<br />вопросы и подготовиться?<br />Эта игра — тренажер собеседования<br />в крупную FMCG компанию!<br />Постарайся подобрать подходящие<br />ответы и замэтчиться с HR!
            </p>
